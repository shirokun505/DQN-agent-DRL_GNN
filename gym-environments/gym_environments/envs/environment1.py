...
class Env1(gym.Env):
  ...
  """
    def __init__(self):
        ...
        self.numEdges = 5  # Example: Set this to the actual number of edges in your environment
        

        # Define observation space and action space
        self.observation_space = spaces.Box(low=0, high=np.inf, shape=(self.numEdges, 2), dtype=np.float32)  # Ensure numEdges is defined
        self.action_space = spaces.Discrete(self.K)  # Ensure K is defined
